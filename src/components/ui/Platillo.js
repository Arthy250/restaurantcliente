            ...
            <div className='p-5 shadow bg-white'>
                <div className='lg:flex'>
                    <div className='lg:w-5/12 xl:w-3/12'>
                        ...
                        <div className='sm:flex sm:-mx-2 pl-3'>
                            <label className='block mt-5 sm:w-2/4'>
                                ...
                                <select 
                                    className='bg-white shadow appearance-none border rounded w-full py-2 px-3 leading-tight outline:none'
                                    value={existencia}
                                    ref={existenciaRef}
                    ...
                    <div className='lg:w-7/12 xl:w-9/12 pl-5'>
                        <p className='font-bold text-2xl text-yellow-600 mb-3'>{nombre}</p>
